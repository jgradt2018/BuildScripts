...
call .\buildProp.bat
set envr=TempTrialOrg

call C:\ant\bin\ant -v -f -noclasspath  %baseDirectory%\BuildScripts\build.xml validateTempTrialOrg -logfile .\Logs\validate.%envr%_%logIteration%.log
