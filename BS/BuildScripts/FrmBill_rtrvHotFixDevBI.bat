...
call .\buildProp.bat
set envr=HotFixDevBI

call C:\ant\bin\ant -v -f -noclasspath %baseDirectory%\BuildScripts\build.xml retrieveHotFixDevBI -logfile .\Logs\rtrv.%envr%_%logIteration%.log
