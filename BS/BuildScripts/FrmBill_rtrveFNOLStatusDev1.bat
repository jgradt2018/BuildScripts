...
call .\buildProp.bat
set envr=eFNOLStatusDev1

call C:\ant\bin\ant -v -f -noclasspath %baseDirectory%\BuildScripts\build.xml retrieveeFNOLStatusDev1 -logfile .\Logs\rtrv.%envr%_%logIteration%.log
